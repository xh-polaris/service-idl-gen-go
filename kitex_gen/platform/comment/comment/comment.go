...
func createCommentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.Comment).CreateComment(ctx, req)
		if err != nil {
			return err
		}
	...
	case *CreateCommentArgs:
		success, err := handler.(comment.Comment).CreateComment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateCommentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.Comment).UpdateComment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdateCommentArgs:
		success, err := handler.(comment.Comment).UpdateComment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *UpdateCommentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in UpdateCommentArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *UpdateCommentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in UpdateCommentResult")
	}
	return proto.Marshal(p.Success)
}
...
func deleteCommentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.Comment).DeleteComment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteCommentArgs:
		success, err := handler.(comment.Comment).DeleteComment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func listCommentByParentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.Comment).ListCommentByParent(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListCommentByParentArgs:
		success, err := handler.(comment.Comment).ListCommentByParent(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *ListCommentByParentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in ListCommentByParentArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *ListCommentByParentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in ListCommentByParentResult")
	}
	return proto.Marshal(p.Success)
}
...
func countCommentByParentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.Comment).CountCommentByParent(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CountCommentByParentArgs:
		success, err := handler.(comment.Comment).CountCommentByParent(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *CountCommentByParentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in CountCommentByParentArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *CountCommentByParentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in CountCommentByParentResult")
	}
	return proto.Marshal(p.Success)
}
...
func retrieveCommentByIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.Comment).RetrieveCommentById(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *RetrieveCommentByIdArgs:
		success, err := handler.(comment.Comment).RetrieveCommentById(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *RetrieveCommentByIdArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in RetrieveCommentByIdArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *RetrieveCommentByIdResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in RetrieveCommentByIdResult")
	}
	return proto.Marshal(p.Success)
}
...
func listCommentByAuthorIdAndTypeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.Comment).ListCommentByAuthorIdAndType(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListCommentByAuthorIdAndTypeArgs:
		success, err := handler.(comment.Comment).ListCommentByAuthorIdAndType(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *ListCommentByAuthorIdAndTypeArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in ListCommentByAuthorIdAndTypeArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *ListCommentByAuthorIdAndTypeResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in ListCommentByAuthorIdAndTypeResult")
	}
	return proto.Marshal(p.Success)
}
...
func listCommentByReplyToAndTypeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.Comment).ListCommentByReplyToAndType(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListCommentByReplyToAndTypeArgs:
		success, err := handler.(comment.Comment).ListCommentByReplyToAndType(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *ListCommentByReplyToAndTypeArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in ListCommentByReplyToAndTypeArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *ListCommentByReplyToAndTypeResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in ListCommentByReplyToAndTypeResult")
	}
	return proto.Marshal(p.Success)
}
