...
type Client interface {
	...
	ListCommentByParent(ctx context.Context, Req *comment.ListCommentByParentOrFirstLevelIdReq, callOptions ...callopt.Option) (r *comment.ListCommentByParentOrFirstLevelIdResp, err error)
...
func (p *kCommentServiceClient) ListCommentByParent(ctx context.Context, Req *comment.ListCommentByParentOrFirstLevelIdReq, callOptions ...callopt.Option) (r *comment.ListCommentByParentOrFirstLevelIdResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
