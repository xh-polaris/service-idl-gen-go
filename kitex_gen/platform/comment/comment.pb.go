...
var file_platform_comment_comment_proto_rawDesc = []byte{
	...
	0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71, 0x1a, 0x27, 0x2e, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f,
	...
	0x79, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x28, 0x2e, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f,
	0x72, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x43,
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x79, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x52, 0x65,
	0x71, 0x1a, 0x29, 0x2e, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_platform_comment_comment_proto_depIdxs = []int32{
	...
	0,  // 4: platform.comment.comment.createComment:input_type -> platform.comment.CreateCommentReq
	2,  // 5: platform.comment.comment.updateComment:input_type -> platform.comment.UpdateCommentReq
	4,  // 6: platform.comment.comment.deleteComment:input_type -> platform.comment.DeleteCommentByIdReq
	6,  // 7: platform.comment.comment.listCommentByParent:input_type -> platform.comment.ListCommentByParentReq
	8,  // 8: platform.comment.comment.countCommentByParent:input_type -> platform.comment.CountCommentByParentReq
	10, // 9: platform.comment.comment.retrieveCommentById:input_type -> platform.comment.RetrieveCommentByIdReq
	12, // 10: platform.comment.comment.listCommentByAuthorIdAndType:input_type -> platform.comment.ListCommentByAuthorIdAndTypeReq
	14, // 11: platform.comment.comment.listCommentByReplyToAndType:input_type -> platform.comment.ListCommentByReplyToAndTypeReq
	1,  // 12: platform.comment.comment.createComment:output_type -> platform.comment.CreateCommentResp
	3,  // 13: platform.comment.comment.updateComment:output_type -> platform.comment.UpdateCommentResp
	5,  // 14: platform.comment.comment.deleteComment:output_type -> platform.comment.DeleteCommentByIdResp
	7,  // 15: platform.comment.comment.listCommentByParent:output_type -> platform.comment.ListCommentByParentResp
	9,  // 16: platform.comment.comment.countCommentByParent:output_type -> platform.comment.CountCommentByParentResp
	11, // 17: platform.comment.comment.retrieveCommentById:output_type -> platform.comment.RetrieveCommentByIdResp
	13, // 18: platform.comment.comment.listCommentByAuthorIdAndType:output_type -> platform.comment.ListCommentByAuthorIdAndTypeResp
	15, // 19: platform.comment.comment.listCommentByReplyToAndType:output_type -> platform.comment.ListCommentByReplyToAndTypeResp
