...
type kDataClient struct {
	*kClient
}

func (p *kDataClient) ReportEvent(ctx context.Context, Req *core_api.ReportEventRequest, callOptions ...callopt.Option) (r *core_api.ReportEventResponse, err error) {
