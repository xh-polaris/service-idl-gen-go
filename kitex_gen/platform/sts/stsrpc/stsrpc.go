...
func serviceInfo() *kitex.ServiceInfo {
	return stsRpcServiceInfo
}

var stsRpcServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "sts_rpc"
	handlerType := (*sts.StsRpc)(nil)
...
func genCosStsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(sts.StsRpc).GenCosSts(ctx, req)
		if err != nil {
			return err
		}
	...
	case *GenCosStsArgs:
		success, err := handler.(sts.StsRpc).GenCosSts(ctx, s.Req)
		if err != nil {
			return err
		}
...
func genSignedUrlHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(sts.StsRpc).GenSignedUrl(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GenSignedUrlArgs:
		success, err := handler.(sts.StsRpc).GenSignedUrl(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteObjectHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(sts.StsRpc).DeleteObject(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteObjectArgs:
		success, err := handler.(sts.StsRpc).DeleteObject(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getAccessTokenHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(sts.StsRpc).GetAccessToken(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetAccessTokenArgs:
		success, err := handler.(sts.StsRpc).GetAccessToken(ctx, s.Req)
		if err != nil {
			return err
		}
