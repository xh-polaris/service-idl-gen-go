...
func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "Auth"
	handlerType := (*authentication.Auth)(nil)
...
func signInHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(authentication.Auth).SignIn(ctx, req)
		if err != nil {
			return err
		}
	...
	case *SignInArgs:
		success, err := handler.(authentication.Auth).SignIn(ctx, s.Req)
		if err != nil {
			return err
		}
...
func setPasswordHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(authentication.Auth).SetPassword(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SetPasswordArgs:
		success, err := handler.(authentication.Auth).SetPassword(ctx, s.Req)
		if err != nil {
			return err
		}
...
func sendVerifyCodeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(authentication.Auth).SendVerifyCode(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SendVerifyCodeArgs:
		success, err := handler.(authentication.Auth).SendVerifyCode(ctx, s.Req)
		if err != nil {
			return err
		}
