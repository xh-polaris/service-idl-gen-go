...
type kMomentServiceClient struct {
	*kClient
}

func (p *kMomentServiceClient) ListMoment(ctx context.Context, Req *moment.ListMomentReq, callOptions ...callopt.Option) (r *moment.ListMomentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ListMoment(ctx, Req)
}

func (p *kMomentServiceClient) CountMoment(ctx context.Context, Req *moment.CountMomentReq, callOptions ...callopt.Option) (r *moment.CountMomentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CountMoment(ctx, Req)
}

func (p *kMomentServiceClient) RetrieveMoment(ctx context.Context, Req *moment.RetrieveMomentReq, callOptions ...callopt.Option) (r *moment.RetrieveMomentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.RetrieveMoment(ctx, Req)
}

func (p *kMomentServiceClient) CreateMoment(ctx context.Context, Req *moment.CreateMomentReq, callOptions ...callopt.Option) (r *moment.CreateMomentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateMoment(ctx, Req)
}

func (p *kMomentServiceClient) UpdateMoment(ctx context.Context, Req *moment.UpdateMomentReq, callOptions ...callopt.Option) (r *moment.UpdateMomentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateMoment(ctx, Req)
}

func (p *kMomentServiceClient) DeleteMoment(ctx context.Context, Req *moment.DeleteMomentReq, callOptions ...callopt.Option) (r *moment.DeleteMomentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
