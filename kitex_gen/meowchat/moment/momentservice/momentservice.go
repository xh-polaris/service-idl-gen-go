...
func serviceInfo() *kitex.ServiceInfo {
	return momentServiceServiceInfo
}

var momentServiceServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "MomentService"
	handlerType := (*moment.MomentService)(nil)
...
func listMomentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(moment.MomentService).ListMoment(ctx, req)
		if err != nil {
			return err
		}
	...
	case *ListMomentArgs:
		success, err := handler.(moment.MomentService).ListMoment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func countMomentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(moment.MomentService).CountMoment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CountMomentArgs:
		success, err := handler.(moment.MomentService).CountMoment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func retrieveMomentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(moment.MomentService).RetrieveMoment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *RetrieveMomentArgs:
		success, err := handler.(moment.MomentService).RetrieveMoment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func createMomentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(moment.MomentService).CreateMoment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CreateMomentArgs:
		success, err := handler.(moment.MomentService).CreateMoment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateMomentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(moment.MomentService).UpdateMoment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdateMomentArgs:
		success, err := handler.(moment.MomentService).UpdateMoment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteMomentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(moment.MomentService).DeleteMoment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteMomentArgs:
		success, err := handler.(moment.MomentService).DeleteMoment(ctx, s.Req)
		if err != nil {
			return err
		}
