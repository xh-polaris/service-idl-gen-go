...
func retrieveNoticeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).RetrieveNotice(ctx, req)
		if err != nil {
			return err
		}
	...
	case *RetrieveNoticeArgs:
		success, err := handler.(system.SystemService).RetrieveNotice(ctx, s.Req)
		if err != nil {
			return err
		}
...
func listNoticeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).ListNotice(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListNoticeArgs:
		success, err := handler.(system.SystemService).ListNotice(ctx, s.Req)
		if err != nil {
			return err
		}
...
func createNoticeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).CreateNotice(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CreateNoticeArgs:
		success, err := handler.(system.SystemService).CreateNotice(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateNoticeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).UpdateNotice(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdateNoticeArgs:
		success, err := handler.(system.SystemService).UpdateNotice(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteNoticeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).DeleteNotice(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteNoticeArgs:
		success, err := handler.(system.SystemService).DeleteNotice(ctx, s.Req)
		if err != nil {
			return err
		}
...
func retrieveNewsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).RetrieveNews(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *RetrieveNewsArgs:
		success, err := handler.(system.SystemService).RetrieveNews(ctx, s.Req)
		if err != nil {
			return err
		}
...
func listNewsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).ListNews(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListNewsArgs:
		success, err := handler.(system.SystemService).ListNews(ctx, s.Req)
		if err != nil {
			return err
		}
...
func createNewsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).CreateNews(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CreateNewsArgs:
		success, err := handler.(system.SystemService).CreateNews(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateNewsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).UpdateNews(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdateNewsArgs:
		success, err := handler.(system.SystemService).UpdateNews(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteNewsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).DeleteNews(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteNewsArgs:
		success, err := handler.(system.SystemService).DeleteNews(ctx, s.Req)
		if err != nil {
			return err
		}
...
func retrieveAdminHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).RetrieveAdmin(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *RetrieveAdminArgs:
		success, err := handler.(system.SystemService).RetrieveAdmin(ctx, s.Req)
		if err != nil {
			return err
		}
...
func listAdminHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).ListAdmin(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListAdminArgs:
		success, err := handler.(system.SystemService).ListAdmin(ctx, s.Req)
		if err != nil {
			return err
		}
...
func createAdminHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).CreateAdmin(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CreateAdminArgs:
		success, err := handler.(system.SystemService).CreateAdmin(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateAdminHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).UpdateAdmin(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdateAdminArgs:
		success, err := handler.(system.SystemService).UpdateAdmin(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteAdminHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).DeleteAdmin(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteAdminArgs:
		success, err := handler.(system.SystemService).DeleteAdmin(ctx, s.Req)
		if err != nil {
			return err
		}
...
func retrieveUserRoleHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).RetrieveUserRole(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *RetrieveUserRoleArgs:
		success, err := handler.(system.SystemService).RetrieveUserRole(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateUserRoleHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).UpdateUserRole(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdateUserRoleArgs:
		success, err := handler.(system.SystemService).UpdateUserRole(ctx, s.Req)
		if err != nil {
			return err
		}
...
func containsRoleHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).ContainsRole(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ContainsRoleArgs:
		success, err := handler.(system.SystemService).ContainsRole(ctx, s.Req)
		if err != nil {
			return err
		}
...
func retrieveCommunityHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).RetrieveCommunity(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *RetrieveCommunityArgs:
		success, err := handler.(system.SystemService).RetrieveCommunity(ctx, s.Req)
		if err != nil {
			return err
		}
...
func listCommunityHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).ListCommunity(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListCommunityArgs:
		success, err := handler.(system.SystemService).ListCommunity(ctx, s.Req)
		if err != nil {
			return err
		}
...
func createCommunityHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).CreateCommunity(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CreateCommunityArgs:
		success, err := handler.(system.SystemService).CreateCommunity(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateCommunityHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).UpdateCommunity(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdateCommunityArgs:
		success, err := handler.(system.SystemService).UpdateCommunity(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteCommunityHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(system.SystemService).DeleteCommunity(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteCommunityArgs:
		success, err := handler.(system.SystemService).DeleteCommunity(ctx, s.Req)
		if err != nil {
			return err
		}
