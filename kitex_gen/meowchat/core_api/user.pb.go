...
type User struct {
	...
	Motto       *string        `protobuf:"bytes,4,opt,name=motto,proto3,oneof" json:"motto,omitempty"`
	Follower    *int64         `protobuf:"varint,5,opt,name=follower,proto3,oneof" json:"follower,omitempty"`
	Following   *int64         `protobuf:"varint,6,opt,name=following,proto3,oneof" json:"following,omitempty"`
	Article     *int64         `protobuf:"varint,7,opt,name=article,proto3,oneof" json:"article,omitempty"`
	Like        *int64         `protobuf:"varint,8,opt,name=like,proto3,oneof" json:"like,omitempty"`
	IsFollowing *bool          `protobuf:"varint,9,opt,name=isFollowing,proto3,oneof" json:"isFollowing,omitempty"`
	Roles       []*system.Role `protobuf:"bytes,10,rep,name=roles,proto3" json:"roles,omitempty"`
	EnableDebug *bool          `protobuf:"varint,11,opt,name=enableDebug,proto3,oneof" json:"enableDebug,omitempty"`
}
...
var file_meowchat_core_api_user_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x0c, 0x0a, 0x0a, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x49, 0x6e, 0x52, 0x65, 0x71, 0x22, 0x6b, 0x0a, 0x0b, 0x43, 0x68, 0x65, 0x63,
	...
	0x54, 0x69, 0x6d, 0x65, 0x73, 0x12, 0x1e, 0x0a, 0x0a, 0x67, 0x65, 0x74, 0x46, 0x69, 0x73, 0x68,
	0x4e, 0x75, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x67, 0x65, 0x74, 0x46, 0x69,
	0x73, 0x68, 0x4e, 0x75, 0x6d, 0x42, 0x7a, 0x0a, 0x25, 0x63, 0x6f, 0x6d, 0x2e, 0x78, 0x68, 0x70,
	...
	0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x44, 0x67, 0x69, 0x74,
...
var file_meowchat_core_api_user_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_meowchat_core_api_user_proto_goTypes = []interface{}{
	...
	(*CheckInReq)(nil),              // 7: meowchat.core_api.CheckInReq
	(*CheckInResp)(nil),             // 8: meowchat.core_api.CheckInResp
	(*system.Role)(nil),             // 9: meowchat.system.Role
	(*basic.PaginationOptions)(nil), // 10: basic.PaginationOptions
}
var file_meowchat_core_api_user_proto_depIdxs = []int32{
	9,  // 0: meowchat.core_api.User.roles:type_name -> meowchat.system.Role
	0,  // 1: meowchat.core_api.GetUserInfoResp.user:type_name -> meowchat.core_api.User
	10, // 2: meowchat.core_api.SearchUserReq.paginationOption:type_name -> basic.PaginationOptions
