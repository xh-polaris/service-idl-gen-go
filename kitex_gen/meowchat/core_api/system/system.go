...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"GetNotices":           kitex.NewMethodInfo(getNoticesHandler, newGetNoticesArgs, newGetNoticesResult, false),
		"NewNotice":            kitex.NewMethodInfo(newNoticeHandler, newNewNoticeArgs, newNewNoticeResult, false),
		...
		"NewCommunity":         kitex.NewMethodInfo(newCommunityHandler, newNewCommunityArgs, newNewCommunityResult, false),
		"DeleteCommunity":      kitex.NewMethodInfo(deleteCommunityHandler, newDeleteCommunityArgs, newDeleteCommunityResult, false),
		"GetUserRoles":         kitex.NewMethodInfo(getUserRolesHandler, newGetUserRolesArgs, newGetUserRolesResult, false),
...
func (p *GetAdminsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetAdminsArgs")
	}
...
func (p *GetAdminsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetAdminsResult")
	}
...
func (p *NewAdminArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in NewAdminArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *NewAdminResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in NewAdminResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *GetNewsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetNewsArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetNewsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetNewsResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *NewNewsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in NewNewsArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *NewNewsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in NewNewsResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *GetNoticesArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetNoticesArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetNoticesResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetNoticesResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *NewNoticeArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in NewNoticeArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *NewNoticeResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in NewNoticeResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *NewCommunityArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in NewCommunityArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *NewCommunityResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in NewCommunityResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *GetUserRolesArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetUserRolesArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetUserRolesResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetUserRolesResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *UpdateCommunityAdminArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in UpdateCommunityAdminArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *UpdateCommunityAdminResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in UpdateCommunityAdminResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *UpdateSuperAdminArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in UpdateSuperAdminArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *UpdateSuperAdminResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in UpdateSuperAdminResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *GetUserByRoleArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetUserByRoleArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetUserByRoleResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetUserByRoleResult")
	}
	return proto.Marshal(p.Success)
}
