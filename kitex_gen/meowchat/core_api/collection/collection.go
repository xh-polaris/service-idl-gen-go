...
func (p *GetCatPreviewsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetCatPreviewsArgs")
	}
...
func (p *GetCatPreviewsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetCatPreviewsResult")
	}
...
func (p *GetCatDetailArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetCatDetailArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetCatDetailResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetCatDetailResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *NewCatArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in NewCatArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *NewCatResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in NewCatResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *GetImageByCatArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetImageByCatArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetImageByCatResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetImageByCatResult")
	}
	return proto.Marshal(p.Success)
}
