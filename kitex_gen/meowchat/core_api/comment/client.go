...
type Client interface {
	...
	NewComment(ctx context.Context, Req *core_api.NewCommentReq, callOptions ...callopt.Option) (r *core_api.NewCommentResp, err error)
...
func (p *kCommentClient) NewComment(ctx context.Context, Req *core_api.NewCommentReq, callOptions ...callopt.Option) (r *core_api.NewCommentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.NewComment(ctx, Req)
}
