...
func (p *GetMomentPreviewsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetMomentPreviewsArgs")
	}
...
func (p *GetMomentPreviewsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetMomentPreviewsResult")
	}
...
func (p *GetMomentDetailArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in GetMomentDetailArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *GetMomentDetailResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in GetMomentDetailResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *NewMomentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in NewMomentArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *NewMomentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in NewMomentResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *SearchMomentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in SearchMomentArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *SearchMomentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in SearchMomentResult")
	}
	return proto.Marshal(p.Success)
}
