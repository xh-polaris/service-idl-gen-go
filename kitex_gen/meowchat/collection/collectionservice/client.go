...
func (p *kCollectionServiceClient) SearchCat(ctx context.Context, Req *collection.SearchCatReq, callOptions ...callopt.Option) (r *collection.SearchCatResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.SearchCat(ctx, Req)
}

func (p *kCollectionServiceClient) ListCat(ctx context.Context, Req *collection.ListCatReq, callOptions ...callopt.Option) (r *collection.ListCatResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ListCat(ctx, Req)
}

func (p *kCollectionServiceClient) RetrieveCat(ctx context.Context, Req *collection.RetrieveCatReq, callOptions ...callopt.Option) (r *collection.RetrieveCatResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.RetrieveCat(ctx, Req)
}

func (p *kCollectionServiceClient) CreateCat(ctx context.Context, Req *collection.CreateCatReq, callOptions ...callopt.Option) (r *collection.CreateCatResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateCat(ctx, Req)
}

func (p *kCollectionServiceClient) UpdateCat(ctx context.Context, Req *collection.UpdateCatReq, callOptions ...callopt.Option) (r *collection.UpdateCatResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateCat(ctx, Req)
}

func (p *kCollectionServiceClient) DeleteCat(ctx context.Context, Req *collection.DeleteCatReq, callOptions ...callopt.Option) (r *collection.DeleteCatResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeleteCat(ctx, Req)
}

func (p *kCollectionServiceClient) CreateImage(ctx context.Context, Req *collection.CreateImageReq, callOptions ...callopt.Option) (r *collection.CreateImageResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateImage(ctx, Req)
}

func (p *kCollectionServiceClient) DeleteImage(ctx context.Context, Req *collection.DeleteImageReq, callOptions ...callopt.Option) (r *collection.DeleteImageResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeleteImage(ctx, Req)
}

func (p *kCollectionServiceClient) ListImage(ctx context.Context, Req *collection.ListImageReq, callOptions ...callopt.Option) (r *collection.ListImageResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
