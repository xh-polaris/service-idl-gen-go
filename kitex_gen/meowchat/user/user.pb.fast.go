...
func (x *GetUserMissionReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetUserMissionReq[number], err)
}

func (x *GetUserMissionReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *GetUserMissionResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetUserMissionResp[number], err)
}

func (x *GetUserMissionResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.SignInTime, offset, err = fastpb.ReadInt64(buf, _type)
	return offset, err
}

func (x *GetUserMissionResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
...
func (x *GetUserMissionReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *GetUserMissionReq) fastWriteField1(buf []byte) (offset int) {
	if x.UserId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetUserId())
...
func (x *GetUserMissionResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *GetUserMissionResp) fastWriteField1(buf []byte) (offset int) {
	if x.SignInTime == 0 {
		return offset
	}
...
func (x *GetUserMissionResp) fastWriteField2(buf []byte) (offset int) {
	if x.LikeTime == 0 {
		return offset
	}
...
func (x *GetUserMissionReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *GetUserMissionReq) sizeField1() (n int) {
	if x.UserId == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetUserId())
...
func (x *GetUserMissionResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *GetUserMissionResp) sizeField1() (n int) {
	if x.SignInTime == 0 {
		return n
	}
...
func (x *GetUserMissionResp) sizeField2() (n int) {
	if x.LikeTime == 0 {
		return n
	}
...
var fieldIDToName_GetUserMissionReq = map[int32]string{
	1: "UserId",
}

var fieldIDToName_GetUserMissionResp = map[int32]string{
	1: "SignInTime",
	2: "LikeTime",
}
