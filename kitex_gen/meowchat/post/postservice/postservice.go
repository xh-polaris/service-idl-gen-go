...
func createPostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(post.PostService).CreatePost(ctx, req)
		if err != nil {
			return err
		}
	...
	case *CreatePostArgs:
		success, err := handler.(post.PostService).CreatePost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func retrievePostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(post.PostService).RetrievePost(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *RetrievePostArgs:
		success, err := handler.(post.PostService).RetrievePost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updatePostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(post.PostService).UpdatePost(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdatePostArgs:
		success, err := handler.(post.PostService).UpdatePost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deletePostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(post.PostService).DeletePost(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeletePostArgs:
		success, err := handler.(post.PostService).DeletePost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func listPostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(post.PostService).ListPost(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListPostArgs:
		success, err := handler.(post.PostService).ListPost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func countPostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(post.PostService).CountPost(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CountPostArgs:
		success, err := handler.(post.PostService).CountPost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func setOfficialHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(post.PostService).SetOfficial(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SetOfficialArgs:
		success, err := handler.(post.PostService).SetOfficial(ctx, s.Req)
		if err != nil {
			return err
		}
