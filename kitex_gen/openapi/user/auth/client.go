...
func (p *kAuthClient) SignUp(ctx context.Context, Req *user.SignUpReq, callOptions ...callopt.Option) (r *user.SignUpResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.SignUp(ctx, Req)
}

func (p *kAuthClient) GetUserInfo(ctx context.Context, Req *user.GetUserInfoReq, callOptions ...callopt.Option) (r *user.GetUserInfoResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetUserInfo(ctx, Req)
}

func (p *kAuthClient) SetUserInfo(ctx context.Context, Req *user.SetUserInfoReq, callOptions ...callopt.Option) (r *user.SetUserInfoResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.SetUserInfo(ctx, Req)
}

func (p *kAuthClient) CreateKey(ctx context.Context, Req *user.CreateKeyReq, callOptions ...callopt.Option) (r *user.CreateKeyResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateKey(ctx, Req)
}

func (p *kAuthClient) GetKey(ctx context.Context, Req *user.GetKeysReq, callOptions ...callopt.Option) (r *user.GetKeysResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetKey(ctx, Req)
}

func (p *kAuthClient) UpdateKey(ctx context.Context, Req *user.UpdateKeyReq, callOptions ...callopt.Option) (r *user.UpdateKeyResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
