...
func signUpHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Auth).SignUp(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *SignUpArgs:
		success, err := handler.(user.Auth).SignUp(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getUserInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Auth).GetUserInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetUserInfoArgs:
		success, err := handler.(user.Auth).GetUserInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func setUserInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Auth).SetUserInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *SetUserInfoArgs:
		success, err := handler.(user.Auth).SetUserInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func createKeyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Auth).CreateKey(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *CreateKeyArgs:
		success, err := handler.(user.Auth).CreateKey(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getKeyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Auth).GetKey(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetKeyArgs:
		success, err := handler.(user.Auth).GetKey(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateKeyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Auth).UpdateKey(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UpdateKeyArgs:
		success, err := handler.(user.Auth).UpdateKey(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateHostsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Auth).UpdateHosts(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UpdateHostsArgs:
		success, err := handler.(user.Auth).UpdateHosts(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteKeyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Auth).DeleteKey(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeleteKeyArgs:
		success, err := handler.(user.Auth).DeleteKey(ctx, s.Req)
		if err != nil {
			return err
		}
