...
func (x *CreateMarginResp) fastReadField3(buf []byte, _type int8) (offset int, err error) {
...
func (x *CreateMarginResp) fastWriteField3(buf []byte) (offset int) {
	if x.MarginId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 3, x.GetMarginId())
	return offset
}
...
func (x *CreateMarginResp) sizeField3() (n int) {
	if x.MarginId == "" {
		return n
	}
	n += fastpb.SizeString(3, x.GetMarginId())
	return n
}
